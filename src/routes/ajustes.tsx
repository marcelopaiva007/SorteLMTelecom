...
import { autoexcluir, sair } from "@/lib/sorteio.functions";
  ...
  head: () => ({
    meta: [
      { title: "Ajustes e regulamento — Sorteio LM" },
      {
        name: "description",
        content:
          "Avisos, regulamento da campanha e autoexclusão dos sorteios em um clique, sem afetar seu contrato com a L&M Telecom.",
      },
      { property: "og:title", content: "Ajustes e regulamento — Sorteio LM" },
      {
        property: "og:description",
        content: "Regulamento, avisos e autoexclusão do Sorteio LM.",
      },
    ],
  }),
  component: Ajustes,
...
function Ajustes() {
  ...
  // Sair apaga a linha em `sessoes`: o token morre no servidor, não só neste
  // aparelho. Antes ele seguia válido por 7 dias depois do logout.
      ...
      <div className="space-y-4">
        ...
        <div className="border border-border bg-card p-4">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-4 text-[12px] text-muted-foreground">
            <li>
              Participar não custa nada. Não existe venda de número nem pacote
              extra.
            </li>
            <li>
              Números são concedidos por comportamento: assinatura (10),
              reativação (8), quitação de débito (5) e mensalidade em dia (3 por
              mês, +1 a cada 6 meses seguidos, teto 6).
            </li>
            ...
            <li>
              Não há divulgação pública de participantes; só o ganhador é
              anunciado.
            </li>
            <li>
              O critério de apuração é congelado antes da abertura e não muda.
            </li>
          </ul>
        </div>
        ...
        <div className="border border-border bg-card p-4">
          ...
          <p className="mt-2 text-[12px] text-muted-foreground">
            Avisamos pelo WhatsApp cadastrado no contrato quando você ganha
            novos números e quando a campanha é apurada. Nada de mensagens de
            urgência.
          </p>
        </div>
        ...
        <div className="border border-destaque bg-card p-4">
          ...
          <p className="mt-2 text-[12px] text-muted-foreground">
            ...
            <strong className="text-foreground">
              continua cliente da LM normalmente
            </strong>
            : seu plano, sua internet e seu atendimento não mudam em nada.
          </p>
          {!confirmando ? (
            <button
